...
* *Fix Inventario:*
  ![Fix Registro Items](imagenes/pr_fix_inventario.webp)

* *Fix Préstamos:*
  ![Fix Préstamos](imagenes/pr_fix_prestamos.webp)

* *Detalle instalación GH:*
  ![Falla Instalación GH](imagenes/falla_install_gh.jpeg)
